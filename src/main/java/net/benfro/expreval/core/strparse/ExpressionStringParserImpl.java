...
import net.benfro.expreval.core.util.CharStack;
import net.benfro.expreval.core.util.ListStack;

@Slf4j
public class ExpressionStringParserImpl implements ExpressionStringParser {
