package net.benfro.expreval.core.evaluator;
...
class RPNExpressionEvaluatorImplTest {

   private RPNExpressionEvaluatorImpl RPNExpressionEvaluatorImpl;

   @BeforeEach
   void setUp() {
      RPNExpressionEvaluatorImpl = new RPNExpressionEvaluatorImpl();
   }
   ...
   void testSimpleAddition(double result, String rpnExpression) {
      assertEquals(result, RPNExpressionEvaluatorImpl.evaluate(rpnExpression));
   }
